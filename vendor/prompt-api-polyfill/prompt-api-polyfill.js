...
// Iframe-injection logic intentionally disabled.
// The upstream polyfill patches HTMLIFrameElement.prototype.contentWindow and
// installs a MutationObserver on documentElement so it can re-inject itself
// into iframe windows. In a content-script context that's both unnecessary
// (each frame gets its own injection from the extension) and very expensive
// on SPAs with frequent DOM mutations — every page mutation woke the observer.
